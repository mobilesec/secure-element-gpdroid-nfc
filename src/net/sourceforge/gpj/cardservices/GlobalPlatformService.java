...
public class GlobalPlatformService implements ISO7816, APDUListener {
    ...
    public void openSecureChannel(int keySet, int keyId, int keyVersion, int scpVersion,
        ...
        if (result.length != 28) {
            throw new CardException("Wrong initialize update response length." + GPUtil.byteArrayToString(result));
        }
...
//    }
    ...
    public static GlobalPlatformService openService(String[] args, CardTerminal terminal) throws IOException {
